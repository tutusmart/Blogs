# 说说对git pull 和 git fetch 的理解？有什么区别？
 ...
 ![](../sImgs/cc90c050-fac2-11eb-991d-334fd31f0201.png)
...
再来看一次`git`的工作流程图，如下所示：
 ...
 ![](../sImgs/d523ba60-fac2-11eb-991d-334fd31f0201.png)
...
这时候我们本地相当于存储了两个代码的版本号，我们还要通过`merge`去合并这两个不同的代码版本
 ...
 ![](../sImgs/fd23ff70-fb12-11eb-bc6f-3f06e1491664.png)
...
相比之下，使用`git pull`就更加简单粗暴，会将本地的代码更新至远程仓库里面最新的代码版本，如下图：
 ...
 ![](../sImgs/091b8140-fb13-11eb-bc6f-3f06e1491664.png)
