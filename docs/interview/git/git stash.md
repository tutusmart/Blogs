# 面试官：说说你对git stash 的理解？应用场景？
 ...
 ![](https://www.oss.tuwei.site/blogsImgs/fe/83ddf210-fd6f-11eb-bc6f-3f06e1491664.png)
...
显示保存进度的列表。也就意味着，`git stash`命令可以多次执行，当多次使用`git stash`命令后，栈里会充满未提交的代码，如下：
 ...
 ![](https://www.oss.tuwei.site/blogsImgs/fe/50216dd0-fccf-11eb-bc6f-3f06e1491664.png)
...
通过使用`git stash show stash@{1}`查看指定的`stash`和当前目录差异
 ...
 ![](https://www.oss.tuwei.site/blogsImgs/fe/458620a0-fccf-11eb-bc6f-3f06e1491664.png)
