# 面试官：说说Git常用的命令有哪些？
 ...
 ![](https://www.oss.tuwei.site/blogsImgs/fe/f66b3290-f7af-11eb-bc6f-3f06e1491664.png)
...
`git `的操作可以通过命令的形式如执行，日常使用就如下图6个命令即可
 ...
 ![](https://www.oss.tuwei.site/blogsImgs/fe/fe150520-f7af-11eb-991d-334fd31f0201.png)
...
`git`常用命令速查表如下所示：
 ...
 ![](https://www.oss.tuwei.site/blogsImgs/fe/0a10f3c0-f7b0-11eb-991d-334fd31f0201.png)
