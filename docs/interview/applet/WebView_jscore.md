-  # 面试官：说说微信小程序的实现原理？
   ...
   ![](../sImgs/4407cb60-3722-11ec-a752-75723a64e8f5.png)
  ...
  而在小程序中，选择了 `Hybrid` 的渲染方式，将视图层和逻辑层是分开的，双线程同时运行，视图层的界面使用 `WebView` 进行渲染，逻辑层运行在 `JSCore` 中
   ...
   ![](../sImgs/4e322e50-3722-11ec-8e64-91fdec0f05a1.png)
  ...
  因此逻辑层与渲染层需要有一定的机制保证时序正确，在每个小程序页面的生命周期中，存在着若干次页面数据通信
   ...
   ![](../sImgs/6cb798b0-3722-11ec-a752-75723a64e8f5.png)
  ...
  >  3.短时间内收到系统两次以上内存警告，也会对小程序进行销毁，这也就为什么一旦页面内存溢出，页面会奔溃的本质原因了
   ...
   ![](../sImgs/968c8510-3722-11ec-a752-75723a64e8f5.png)
