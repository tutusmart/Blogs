...
![](https://tuwei.site/ui/sImgs/02ac1620-3ac6-11eb-85f6-6fac77c0c9b3.png)
...
石器时代指的就是我们的静态网页，可以欣赏一下1997的Apple官网
 ...
 ![](https://tuwei.site/ui/sImgs/1734e450-3ac6-11eb-85f6-6fac77c0c9b3.png)

最早的网页是没有数据库的，可以理解成就是一张可以在网络上浏览的报纸，直到CGI技术的出现通过 CGI Perl 运行一小段代码与数据库或文件系统进行交互，如当时的Google（1998年）

 ![](https://tuwei.site/ui/sImgs/23189000-3ac6-11eb-85f6-6fac77c0c9b3.png)
...
这里没有文字，放一张图感受一下
 ...
 ![](https://tuwei.site/ui/sImgs/32a6f430-3ac6-11eb-85f6-6fac77c0c9b3.png)
...
这时候需要一张直观的关系图，如下
 ![image.png](https://tuwei.site/ui/sImgs/4402c560-3ac6-11eb-85f6-6fac77c0c9b3.png)
...
没有落地使用场景的革命不是好革命，就以一个高频的应用场景来示意吧注册账号这个需求大家应该很熟悉了，如下
 ...
 ![](https://tuwei.site/ui/sImgs/5ae84840-3ac6-11eb-ab90-d9ae814b240d.png)

用`jquery`来实现大概的思路就是选择流程dom对象，点击按钮隐藏当前活动流程dom对象，显示下一流程dom对象如下图\(代码就不上了，上了就篇文章就没了..\)

 ![](https://tuwei.site/ui/sImgs/65f89e60-3ac6-11eb-85f6-6fac77c0c9b3.png)

用`vue`来实现，我们知道`vue`基本不操作`dom`节点， 双向绑定使`dom`节点跟视图绑定后，通过修改变量的值控制`dom`节点的各类属性。所以其实现思路为：视图层使用一变量控制dom节点显示与否，点击按钮则改变该变量，如下图

 ![](https://tuwei.site/ui/sImgs/6f916fb0-3ac6-11eb-ab90-d9ae814b240d.png)
