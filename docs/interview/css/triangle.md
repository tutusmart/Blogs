...
![](../sImgs/bd310120-a279-11eb-85f6-6fac77c0c9b3.png)

## 一、前言

在前端开发的时候，我们有时候会需要用到一个三角形的形状，比如地址选择或者播放器里面播放按钮

 ![](../sImgs/d6d8ff60-a279-11eb-85f6-6fac77c0c9b3.png)
...
效果如下图所示：
 ...
 ![](../sImgs/e3f244e0-a279-11eb-ab90-d9ae814b240d.png)

将`border`设置`50px`，效果图如下所示：

 ![](../sImgs/ee0b42b0-a279-11eb-ab90-d9ae814b240d.png)

白色区域则为`width`、`height`，这时候只需要你将白色区域部分宽高逐渐变小，最终变为0，则变成如下图所示：

 ![](../sImgs/2afaa030-a27a-11eb-85f6-6fac77c0c9b3.png)
...
效果图如下所示：
 ...
 ![i](../sImgs/59f4d720-a27a-11eb-85f6-6fac77c0c9b3.png)

伪类元素定位参照对象的内容区域宽高都为0，则内容区域即可以理解成中心一点，所以伪元素相对中心这点定位

将元素定位进行微调以及改变颜色，就能够完成下方效果图：

 ![](../sImgs/653a6e10-a27a-11eb-85f6-6fac77c0c9b3.png)
...
可以看到，边框是实现三角形的部分，边框实际上并不是一个直线，如果我们将四条边设置不同的颜色，将边框逐渐放大，可以得到每条边框都是一个梯形
 ...
 ![](../sImgs/78d4bd90-a27a-11eb-85f6-6fac77c0c9b3.png)
...
- 当保留边没有其他接触时，极限情况所有东西都会消失
 ...
 ![](../sImgs/84586ef0-a27a-11eb-85f6-6fac77c0c9b3.png)
