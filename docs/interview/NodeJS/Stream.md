# 面试官：说说对 Node 中的 Stream 的理解？应用场景？
 ...
 ![](https://www.oss.tuwei.site/blogsImgs/fe/a5df3c60-c76f-11eb-ab90-d9ae814b240d.png)
...
在`source`和`dest`之间有一个连接的管道`pipe`,它的基本语法是`source.pipe(dest)`，`source`和`dest`就是通过pipe连接，让数据从`source`流向了`dest`，如下图所示：
 ...
 ![](https://www.oss.tuwei.site/blogsImgs/fe/aec05670-c76f-11eb-ab90-d9ae814b240d.png)
...
如下图所示：
 ...
 ![](https://www.oss.tuwei.site/blogsImgs/fe/b7ac6d00-c76f-11eb-ab90-d9ae814b240d.png)
...
双工流的演示图如下所示：
 ...
 ![](https://www.oss.tuwei.site/blogsImgs/fe/c02883b0-c76f-11eb-ab90-d9ae814b240d.png)
