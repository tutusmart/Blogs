# 面试官：说说你对快速排序的理解？如何实现？应用场景？
 ...
 ![](https://www.oss.tuwei.site/blogsImgs/fe/bafae570-268a-11ec-8e64-91fdec0f05a1.png)
...
最好情况下是`O(nlogn)`，其中递归算法的时间复杂度公式：`T[n] = aT[n/b] + f(n)`，推导如下所示：
 ...
 ![](https://www.oss.tuwei.site/blogsImgs/fe/b6019540-2b5e-11ec-8e64-91fdec0f05a1.png)
