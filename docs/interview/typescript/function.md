# 面试官：说说你对 TypeScript 中函数的理解？与 JavaScript 函数的区别？
 ...
 ![](https://www.oss.tuwei.site/blogsImgs/fe/3f1c1390-0d42-11ec-a752-75723a64e8f5.png)
...
上述只定义了函数的两个参数类型，这个时候整个函数虽然没有被显式定义，但是实际上` TypeScript` 编译器是能够通过类型推断到这个函数的类型，如下图所示：
 ...
 ![](https://www.oss.tuwei.site/blogsImgs/fe/4b3415b0-0d42-11ec-8e64-91fdec0f05a1.png)
