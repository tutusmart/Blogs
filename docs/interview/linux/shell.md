# 面试官：说说你对 shell 的理解？常见的命令？
 ...
 ![](https://www.oss.tuwei.site/blogsImgs/fe/71003620-0883-11ec-a752-75723a64e8f5.png)
...
主要作用是接收用户输入的命令，并对命令进行处理，处理完毕后再将结果反馈给用户，比如输出到显示器、写入到文件等，同样能够调用和组织其他的应用程序，相当于一个领导者的身份，如下图：
 ...
 ![](https://www.oss.tuwei.site/blogsImgs/fe/80db0ca0-0883-11ec-8e64-91fdec0f05a1.png)
...
![](https://www.oss.tuwei.site/blogsImgs/fe/8e739440-0883-11ec-a752-75723a64e8f5.png)
