...
![](https://www.oss.tuwei.site/blogsImgs/fe/7df7d830-3b2b-11ec-8e64-91fdec0f05a1.png)
  ...
  在应用程序运行期间，单例模式只会在全局作用域下创建一次实例对象，让所有需要调用的地方都共享这一单例对象，如下图所示：
   ...
   ![](https://www.oss.tuwei.site/blogsImgs/fe/fa7898d0-3b2c-11ec-8e64-91fdec0f05a1.png)
...
在`javascript`中，实现一个单例模式可以用一个变量来标志当前的类已经创建过对象，如果下次获取当前类的实例时，直接返回之前创建的对象即可，如下：
  ...
  并且`Vuex`、`redux`全局态管理库也应用单例模式的思想，如下图：
   ...
   ![](https://www.oss.tuwei.site/blogsImgs/fe/8be50f80-3b2b-11ec-a752-75723a64e8f5.png)
