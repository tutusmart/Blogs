# 面试官：举例说明你对尾递归的理解，有哪些应用场景
 ...
 ![](https://www.oss.tuwei.site/blogsImgs/fe/74db8fe0-815d-11eb-85f6-6fac77c0c9b3.png)
...
也就是说`pow` 递归地调用自身 直到 `n == 1`
 ...
 ![](https://www.oss.tuwei.site/blogsImgs/fe/8002c960-815d-11eb-ab90-d9ae814b240d.png)
