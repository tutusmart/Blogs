# 面试官：DOM常见的操作有哪些？
 ...
 ![](https://www.oss.tuwei.site/blogsImgs/fe/a89c99a0-7fdc-11eb-ab90-d9ae814b240d.png)
...
除此之外，每个`DOM`元素还有`parentNode`、`childNodes`、`firstChild`、`lastChild`、`nextSibling`、`previousSibling`属性，关系图如下图所示
 ...
 ![](https://www.oss.tuwei.site/blogsImgs/fe/c100f450-7fdc-11eb-ab90-d9ae814b240d.png)
