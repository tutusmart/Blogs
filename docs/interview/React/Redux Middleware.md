# 面试官：说说对Redux中间件的理解？常用的中间件有哪些？实现原理？
 ...
 ![](https://www.oss.tuwei.site/blogsImgs/fe/4520bbd0-e699-11eb-ab90-d9ae814b240d.png)
...
`Redux`中，中间件就是放在就是在`dispatch`过程，在分发`action`进行拦截处理，如下图：
 ...
 ![](https://www.oss.tuwei.site/blogsImgs/fe/57edf750-e699-11eb-ab90-d9ae814b240d.png)
