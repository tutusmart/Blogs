...
![](https://www.oss.tuwei.site/blogsImgs/fe/f1d36350-d302-11eb-85f6-6fac77c0c9b3.png)

## 一、是什么

Real DOM，真实 `DOM`，意思为文档对象模型，是一个结构化文本的抽象，在页面渲染出的每一个结点都是一个真实 `DOM` 结构，如下：

![](https://www.oss.tuwei.site/blogsImgs/fe/fc7ba8d0-d302-11eb-85f6-6fac77c0c9b3.png)
...
![](https://www.oss.tuwei.site/blogsImgs/fe/1716b9a0-d303-11eb-ab90-d9ae814b240d.png)
